...
<!-- 
<div id="stickyBar"
    class="hidden lg:block fixed right-0 top-1/2 -translate-y-1/2 z-50"> -->
<div id="stickyBar"
...
<!-- <div id="stickyBar"
    ...
    fixed right-4 bottom-6 z-50 gap-2">

    <a href="#"
        class="w-14 h-14 bg-secondary text-white flex items-center justify-center shadow-lg">
        <i class="fa-regular fa-calendar-check"></i>
    </a>

    <a href="#"
        class="w-14 h-14 bg-primary text-white flex items-center justify-center shadow-lg">
