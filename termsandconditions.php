    ...
    <div class="container-custom">
        <div
            ...
            <div
                ...
                <div class="relative">
                    <img
                        src="./assets/img/terms-overview.jpg"
                        alt="Terms Overview"
                    ...
                    <div
                        ...
                        <p
                            ...
                            These terms help establish a transparent
                            relationship between patients, visitors
                            and CIWEC Hospital.
                        </p>
                    </div>
                </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex gap-4">
                        ...
                        <span>
                            Defines the use of our healthcare services.
                        </span>
                    </div>
                    <div class="flex gap-4">
                        <i
                        ...
                        <span>
                            Explains patient and visitor responsibilities.
                        </span>
                    </div>
                    <div class="flex gap-4">
                        <i
                        ...
                        <span>
                            Establishes website usage guidelines.
                        </span>
                    </div>
                    <div class="flex gap-4">
                        <i
                        ...
                        <span>
                            Supports transparency and legal compliance.
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="container-custom">
        ...
        <div
            ...
            <div
                class="lg:col-span-5">
                <img
                    src="./assets/img/acceptance-terms.jpg"
        ...
        <div class="py-24 lg:py-32">
            ...
            <div
                ...
                <p
                    ...
                    Information provided on this website is intended
                    for general educational purposes and should not
            ...
            <div
                ...
                <!-- EDUCATIONAL -->
                <div
                    class="bg-white/5 border border-white/10 p-8 hover:border-secondary transition-all duration-500">
                    <div
                        class="w-20 h-20 bg-blue-500/10 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-book-medical text-blue-400 text-3xl">
                        </i>
                    </div>
                    <h3
                    ...
                    <p
                        class="text-white/60 mt-5 leading-7">
                        Content on this website is provided to
                        support awareness and understanding of
                        healthcare topics.
                    </p>
                </div>
                <!-- NOT MEDICAL ADVICE -->
                <div
                    class="bg-white/5 border border-white/10 p-8 hover:border-secondary transition-all duration-500">
                    <div
                        class="w-20 h-20 bg-orange-500/10 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-user-doctor text-orange-400 text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-5 leading-7">
                        Website information should never replace
                ...
                <div
                    class="bg-white/5 border border-white/10 p-8 hover:border-secondary transition-all duration-500">
                    <div
                        class="w-20 h-20 bg-red-500/10 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-truck-medical text-red-400 text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-5 leading-7">
                        In a medical emergency, contact emergency
                ...
                <div
                    class="bg-white/5 border border-white/10 p-8 hover:border-secondary transition-all duration-500">
                    <div
                        class="w-20 h-20 bg-green-500/10 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-stethoscope text-green-400 text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-5 leading-7">
                        Always seek professional advice regarding
            ...
            <div
                class="mt-24 bg-white/5 border border-red-500/20 overflow-hidden">
                <div
                    class="grid lg:grid-cols-12 items-center">
                    <div
                        class="lg:col-span-7 p-10 lg:p-14">
                        <span
                            class="text-red-400 font-bold uppercase tracking-[3px]">
                            Important Notice
                        </span>
                        <h3
                            class="text-white text-4xl font-black mt-5">
                            Never Ignore Professional
                            Medical Advice
                        </h3>
                        <p
                            class="text-white/70 mt-6 leading-8">
                            Do not disregard professional medical
                            advice or delay seeking treatment because
                            of information obtained from this website.
                            Individual medical situations vary and
                            require personalized evaluation.
                        </p>
                        <div
                            class="space-y-5 mt-10">
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                                <span class="text-white">Consult qualified healthcare professionals</span>
                            </div>
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                                <span class="text-white">Seek immediate help during emergencies</span>
                            </div>
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                                <span class="text-white">Use website information responsibly</span>
                            </div>
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                                <span class="text-white">Follow individualized medical guidance</span>
                            </div>
                        </div>
                    </div>
                    <div
                        class="lg:col-span-5 bg-red-600 h-full flex items-center">
                        <div
                            class="p-10 lg:p-14 text-center w-full">
                            <i
                                class="fa-solid fa-triangle-exclamation text-white text-8xl">
                            </i>
                            <h4
                            ...
                            <p
                                class="text-white/90 mt-5 leading-8">
            ...
            <!-- DISCLAIMER STRIP -->
            <div
                class="mt-24 text-center max-w-5xl mx-auto">
                <h3
                ...
                <p
                    class="text-white/60 mt-8 leading-8">
                    The information available through this website
                    is intended to complement healthcare discussions
                    and educational resources, but it should never
                    replace direct consultation with qualified
...
<section class="section-padding bg-white overflow-hidden">
    <div class="container-custom">
        ...
        <div class="text-center max-w-4xl mx-auto mb-20">
            ...
            <p
                class="text-slate-600 mt-6 leading-8">
                We encourage visitors to use our website responsibly
                and lawfully. These guidelines help maintain a secure,
                reliable and positive experience for all users.
            </p>
        </div>
        <!-- DO / DON'T SECTION -->
        <div
            ...
            <!-- ALLOWED USE -->
            <div
                class="bg-green-50 border border-green-200 overflow-hidden">
                <div
                    class="bg-green-600 p-6">
                    <div
                ...
                <div class="p-10">
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            ...
                            <span>
                                Browse healthcare information and services.
                            </span>
                        </div>
                        <div class="flex gap-4">
                            <i
                        ...
                        <div class="flex gap-4">
                            ...
                            <span>
                                Use website features for legitimate purposes.
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <!-- PROHIBITED USE -->
            <div
                class="bg-red-50 border border-red-200 overflow-hidden">
                <div
                    class="bg-red-600 p-6">
                    <div
                        class="flex items-center gap-4">
                        <i
                ...
                <div class="p-10">
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            <i
                                class="fa-solid fa-xmark text-red-600 mt-1">
                            </i>
                            <span>
        ...
        <div
            ...
            <div
                ...
                <div
                    class="w-20 h-20 bg-primary/10 flex items-center justify-center mb-6">
                    <i
                        class="fa-solid fa-user-lock text-primary text-3xl">
                    </i>
                </div>
                <h3
                ...
                <p
                    ...
                    If account-based services are available, users
            ...
            <div
                ...
                <div
                    class="w-20 h-20 bg-secondary/10 flex items-center justify-center mb-6">
                    <i
                        class="fa-solid fa-shield-heart text-secondary text-3xl">
                    </i>
                </div>
                <h3
                    class="text-primary text-3xl font-black">
                ...
                <p
                    class="text-slate-600 mt-5 leading-8">
                    Users are expected to access website resources
                    responsibly and avoid activities that may impact
                    the security, availability or performance of
                    hospital systems.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <h3
                        class="text-white text-4xl font-black mt-5">
                        Helping Us Maintain A Safe
                        Digital Environment
                    </h3>
                    <p
                        class="text-white/80 mt-6 leading-8">
                        Following these guidelines helps ensure that
                        our website remains secure, reliable and
                        accessible for patients, visitors and healthcare
                        professionals.
                    </p>
                </div>
                <div
                    ...
                    <div class="text-center">
                        <i
                            class="fa-solid fa-globe text-secondary text-7xl">
                        </i>
                        <h4
                            class="text-white text-2xl font-black mt-6">
                            Safe Access
...
<section class="relative overflow-hidden bg-slate-950">
    <!-- BACKGROUND EFFECTS -->
    <div
        class="absolute top-0 left-0 w-[600px] h-[600px] bg-primary/10 rounded-full -translate-x-1/2 -translate-y-1/2">
    </div>
    <div
        class="absolute bottom-0 right-0 w-[700px] h-[700px] bg-secondary/10 rounded-full translate-x-1/3 translate-y-1/3">
    </div>
    <div class="container-custom relative z-10">
        <div class="py-24 lg:py-32">
            <!-- HEADER -->
            <div
                ...
                <p
                    class="text-white/70 text-lg leading-8 mt-8">
                    Content available on this website is protected by
                    intellectual property laws. Unauthorized use,
                    reproduction or distribution may be prohibited.
                </p>
            </div>
            <!-- PROPERTY CARDS -->
            <div
                ...
                <div
                    class="bg-white/5 border border-white/10 p-8 hover:border-secondary transition-all duration-500">
                    <div
                        class="w-20 h-20 bg-primary/20 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-file-lines text-secondary text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-4 leading-7">
                        Text, articles, pages and written materials
                ...
                <div
                    ...
                    <p
                        class="text-white/60 mt-4 leading-7">
                        Names, branding elements and visual
                        identity associated with CIWEC Hospital.
                    </p>
                </div>
                <!-- LOGOS -->
                <div
                    ...
                    <div
                        class="w-20 h-20 bg-primary/20 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-shield text-secondary text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-4 leading-7">
                        Protected visual assets, symbols,
                ...
                <div
                    ...
                    <div
                        class="w-20 h-20 bg-primary/20 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-image text-secondary text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-4 leading-7">
                        Photographs, videos and multimedia
                        resources displayed on the website.
                    </p>
                </div>
                <!-- EDUCATIONAL -->
                <div
                    ...
                    <div
                        class="w-20 h-20 bg-primary/20 flex items-center justify-center mb-6">
                        <i
                            class="fa-solid fa-book-medical text-secondary text-3xl">
                        </i>
                    </div>
                    <h3
                        class="text-white text-2xl font-black">
                    ...
                    <p
                        class="text-white/60 mt-4 leading-7">
                        Healthcare resources, guides and
                        educational content.
                    </p>
                </div>
            </div>
            <!-- MAIN CONTENT -->
            <div
                class="mt-24 bg-white/5 border border-white/10 overflow-hidden">
                <div
                    class="grid lg:grid-cols-12 items-center">
                    <!-- CONTENT -->
                    <div
                        ...
                        <p
                            class="text-white/70 mt-6 leading-8">
                            Unless otherwise stated, content appearing
                            on this website remains the property of
                            CIWEC Hospital or its respective licensors.
                            Users may access content for personal,
                        ...
                        <div
                            ...
                            <div class="flex gap-4">
                                ...
                                <span class="text-white">
                                    Personal viewing and educational use permitted
                                </span>
                            </div>
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                                <span class="text-white">
                                    Attribution may be required where applicable
                                </span>
                            </div>
                            <div class="flex gap-4">
                                <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <i
                                class="fa-solid fa-copyright text-secondary text-8xl">
                            </i>
                            <h4
                                class="text-white text-3xl font-black mt-8">
                                Protected Content
            ...
            <div
                ...
                <!-- PERMITTED -->
                <div
                    class="bg-green-500/10 border border-green-500/20 p-10">
                    <h3
                        class="text-green-400 text-3xl font-black">
                        Permitted Use
                    </h3>
                    <ul
                        class="space-y-4 mt-8 text-white">
                        <li>✓ Personal viewing</li>
                        <li>✓ Educational reference</li>
                        <li>✓ Healthcare information access</li>
                        <li>✓ Non-commercial use</li>
                    </ul>
                </div>
                <!-- RESTRICTED -->
                <div
                    class="bg-red-500/10 border border-red-500/20 p-10">
                    <h3
                        class="text-red-400 text-3xl font-black">
                    ...
                    <ul
                        ...
                        <li>✕ Content modification without permission</li>
                    </ul>
                </div>
            </div>
            <!-- FOOTER STRIP -->
            <div
                ...
                <h3
                    ...
                    Supports Innovation & Trust
                </h3>
                <p
                    class="text-white/60 mt-8 leading-8">
                    We appreciate responsible use of our content and
                    ask users to respect intellectual property rights,
                    trademarks and copyrighted materials available
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <p
                        class="text-slate-600 mt-6 leading-8">
                        CIWEC Hospital works diligently to provide
                        quality healthcare services and maintain a
                        reliable website experience. However, users
                        acknowledge that certain risks, interruptions
                        and variables may exist despite reasonable
                    ...
                    <div
                        ...
                        <div class="flex gap-4">
                            <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                            <span>Continuous improvement efforts</span>
                        </div>
                        <div class="flex gap-4">
                            <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                            <span>Operational disruptions may occur</span>
                        </div>
                        <div class="flex gap-4">
                            <i class="fa-solid fa-circle-check text-secondary mt-1"></i>
                            <span>Individual circumstances vary</span>
                        </div>
                    </div>
                </div>
                <!-- VISUAL PANEL -->
                <div
                    ...
                    <div
                        class="text-center p-12">
                        <i
                            class="fa-solid fa-scale-balanced text-secondary text-8xl">
                        </i>
                        <h4
                            class="text-white text-3xl font-black mt-8">
                        ...
                        <p
                            class="text-white/80 mt-5 leading-8">
                            Transparency helps patients and visitors
                            better understand the scope and limitations
                            of website and healthcare services.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    ...
                    <p
                        ...
                        Website content should be used as a general
                        informational resource. Healthcare decisions
                        should always be made in consultation with
                        qualified healthcare professionals based on
    ...
    <div class="container-custom">
        ...
        <div
            ...
            <div
                class="lg:col-span-5">
                <img
                    src="./assets/img/terms-updates.jpg"
    ...
    <div class="container-custom">
        ...
        <div class="text-center max-w-4xl mx-auto mb-20">
            ...
            <p
                ...
                Conditions, website usage, appointments or healthcare
                services, our team is available to assist you.
            </p>
        </div>
        ...
        <div
            ...
            <div
                ...
                <h3
                    class="text-primary text-4xl font-black mt-5">
                    Contact CIWEC Hospital
                </h3>
                <p
                    class="text-slate-600 mt-6 leading-8">
                    Whether you have questions about our terms,
                    services, website functionality or appointment
                    policies, please don't hesitate to reach out.
                </p>
                <!-- CONTACT CARDS -->
                <div
                    ...
                    <!-- EMAIL -->
                    <div
                        class="bg-white border border-slate-200 p-6 text-center hover:border-primary transition-all duration-300">
                        <div
                            class="w-16 h-16 mx-auto bg-primary/10 flex items-center justify-center mb-5">
                            <i
                                class="fa-solid fa-envelope text-primary text-2xl">
                            </i>
                        </div>
                        <h4
                        ...
                        <p
                            class="text-slate-600 mt-3 text-sm break-all">
                            info@ciwec.com.np
                        </p>
                    </div>
                    <!-- PHONE -->
                    <div
                        class="bg-white border border-slate-200 p-6 text-center hover:border-secondary transition-all duration-300">
                        <div
                            class="w-16 h-16 mx-auto bg-secondary/10 flex items-center justify-center mb-5">
                            <i
                                class="fa-solid fa-phone text-secondary text-2xl">
                            </i>
                        </div>
                        <h4
                            class="text-primary font-black text-xl">
                        ...
                        <p
                            class="text-slate-600 mt-3 text-sm">
                            +977-1-4524111
                        </p>
                    </div>
                    <!-- ADDRESS -->
                    <div
                        ...
                        <div
                            class="w-16 h-16 mx-auto bg-primary/10 flex items-center justify-center mb-5">
                            <i
                                class="fa-solid fa-location-dot text-primary text-2xl">
                            </i>
                        </div>
                        <h4
                            class="text-primary font-black text-xl">
                ...
                <!-- INFORMATION BOX -->
                <div
                    class="mt-12 p-6 bg-primary/5 border border-primary/10">
                    <div class="flex gap-4">
                        <i
                            class="fa-solid fa-circle-info text-secondary text-xl mt-1">
                        </i>
                        <p
                            class="text-slate-700 leading-7">
                            For faster assistance, please provide
                            relevant details regarding your inquiry,
                            including any questions related to website
                            use, appointments or hospital policies.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <img
                    src="./assets/img/contact-terms.jpg"
                    alt="Contact Information"
                    class="w-full h-full min-h-[650px] object-cover">
                <!-- OVERLAY CARD -->
                <div
                    class="absolute bottom-8 left-8 right-8 bg-white p-8 shadow-2xl">
                    <div
                        class="flex items-center gap-4">
                        <div
                            class="w-16 h-16 bg-primary/10 flex items-center justify-center">
                            <i
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <p
                        class="text-white/80 mt-6 leading-8">
                        Contact us if you need clarification regarding
                        these Terms & Conditions, appointment policies,
                        healthcare services or website usage.
                    </p>
                </div>
                <div
                    class="lg:col-span-4 p-10">
                    <div
                        ...
                        <a
                            href="mailto:info@ciwec.com.np"
                            class="border border-white text-white text-center py-4 font-bold hover:bg-white hover:text-primary transition">
                            Send Email
                        </a>
                    </div>
                </div>
...
<section class="relative overflow-hidden bg-slate-950">
    <!-- BACKGROUND EFFECTS -->
    <div
        class="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/10 rounded-full -translate-x-1/2 -translate-y-1/2">
    </div>
    <div
        class="absolute bottom-0 right-0 w-[700px] h-[700px] bg-secondary/10 rounded-full translate-x-1/3 translate-y-1/3">
    </div>
    <div class="container-custom relative z-10">
        <div class="py-24 lg:py-32">
            <div
                ...
                <!-- ICON -->
                <div
                    class="w-28 h-28 mx-auto bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center">
                    <i
                        class="fa-solid fa-file-contract text-secondary text-5xl">
                    </i>
                </div>
                <!-- LABEL -->
                <span
                    class="inline-block mt-8 text-secondary font-bold uppercase tracking-[4px]">
                    Terms & Conditions
                </span>
                <!-- TITLE -->
                <h2
                    class="text-white text-5xl lg:text-6xl font-black mt-6">
                ...
                <p
                    ...
                    These Terms & Conditions are intended to promote
                    transparency, clarify expectations and support a
                    safe experience for patients, visitors and website
                    users. We encourage you to review them periodically.
                </p>
                <!-- LAST UPDATED CARD -->
                <div
                    class="bg-white/5 border border-white/10 backdrop-blur-sm p-10 mt-16 max-w-2xl mx-auto">
                    <span
                        class="text-secondary font-bold uppercase tracking-[3px]">
                        Last Updated
                    </span>
                    ...
                    <p
                        class="text-white/60 mt-4">
                        Updates may be made periodically to reflect
                        operational, legal or service-related changes.
                    </p>
                </div>
                <!-- HIGHLIGHT CARDS -->
                <div
                    ...
                    <div
                        ...
                        <h4
                            class="text-white text-xl font-black mt-5">
                            Fair Use
                        </h4>
                        <p
                            class="text-white/60 mt-3">
                            Supporting responsible and lawful use
                    ...
                    <div
                        class="bg-white/5 border border-white/10 p-8">
                        <i
                            class="fa-solid fa-shield-halved text-secondary text-3xl">
                        </i>
                        <h4
                            class="text-white text-xl font-black mt-5">
                            Transparency
                ...
                <!-- ACCEPTANCE NOTICE -->
                <div
                    class="mt-16 bg-primary/20 border border-primary/30 p-8 max-w-4xl mx-auto">
                    <div
                        class="flex flex-col md:flex-row items-center gap-5 justify-center">
                        <i
                            class="fa-solid fa-circle-check text-secondary text-3xl">
                        </i>
                        <p
                            class="text-white text-lg leading-8">
                            Continued use of our website, services,
                            appointment systems and healthcare resources
                ...
                <!-- CTA BUTTONS -->
                <div
                    class="flex flex-wrap justify-center gap-5 mt-16">
                    <a
                        href="/contact"
                        class="bg-secondary text-white px-8 py-4 font-bold hover:bg-white hover:text-primary transition">
                        Contact Us
                ...
                <!-- FOOTNOTE -->
                <p
                    class="text-white/50 text-sm mt-12 max-w-3xl mx-auto leading-7">
                    If you have questions regarding these Terms &
                    Conditions, please contact CIWEC Hospital using
                    the contact information provided above. We are
                    committed to transparency, patient care and
